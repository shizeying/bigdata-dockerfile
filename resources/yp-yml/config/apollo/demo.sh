...
echo ${apollo_config_db_url}
echo ${apollo_portal_db_url}
# handle env
if [[ -n "$JAVA_OPTS" ]]; then
...
# meta server url
config_server_url=http://${EUREKA_INSTANCE_IP_ADDRESS:-localhost}:8080
admin_server_url=http://${EUREKA_INSTANCE_IP_ADDRESS:-localhost}:8090
eureka_service_url=$config_server_url/eureka/
portal_url=http://${EUREKA_INSTANCE_IP_ADDRESS:-localhost}:8070
